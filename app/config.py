...
class Settings(BaseSettings):
    ...
    webchat_channel_id: str = "webchat_main"  # deprecated: only used to filter legacy data
    webchat_channel_name: str = "WebChat"  # deprecated
    webchat_user_id: str = "web_user"  # deprecated: only used to filter legacy data
    webchat_user_name: str = "Web User"  # deprecated
